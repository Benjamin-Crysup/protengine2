...
COPY includes_profinman\*.h builds\inc_x64_win32
...
FOR %%v in (source_profinman\*.cpp) DO g++ -mthreads %%v -g -O0 -Wall -Ibuilds\inc_x64_win32 -c -o builds\obj_x64_win32\%%~nv.o
g++ -mthreads -o builds\bin_x64_win32\profinman.exe builds\obj_x64_win32\*.o -lz -static-libgcc -static-libstdc++ -static -lpthread

REM builds\bin_x64_win32\proderal --helpdumpgui | python utilities\ArgGuiBuilder.py > builds\bin_x64_win32\proderalgui.py
REM COPY GUI.py builds\bin_x64_win32\

REM builds\bin_x64_win32\proderal --helpdumpgui | python utilities\ManPageBuilder.py proderal "realign sequences in difficult regions" proderalmandesc.txt > builds\bin_x64_win32\proderal.1
